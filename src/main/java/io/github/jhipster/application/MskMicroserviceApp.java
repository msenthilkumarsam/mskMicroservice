...
public class MskMicroserviceApp {

    private static final Logger log = LoggerFactory.getLogger(MskMicroserviceApp.class);

    private final Environment env;

    public MskMicroserviceApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes mskMicroservice.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MskMicroserviceApp.class);
